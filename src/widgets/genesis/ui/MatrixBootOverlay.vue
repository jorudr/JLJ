<template>
  <Transition name="fade">
    <div v-if="isInitializing" class="absolute inset-0 z-[1000] bg-theme-bg flex flex-col items-center justify-center space-y-8 pointer-events-auto transition-colors duration-1000">
       ...
       <div class="w-64 h-px bg-theme-text/10 relative overflow-hidden">
       ...
       <div class="flex flex-col items-center space-y-1 opacity-40 text-theme-text">
       ...
       <div class="absolute inset-0 pointer-events-none opacity-5 animate-scan bg-gradient-to-b from-transparent via-theme-text to-transparent h-[2px]"></div>
    </div>
  </Transition>
</template>
